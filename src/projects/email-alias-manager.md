...
tags:
  - angular
  - serverless
metaDescription: Trop de spam ? Marre de donner son addresse email à chaque service ? Les alias mail sont là à la rescousse !
summary: Trop de spam ? Marre de donner son addresse email à chaque service ? Les alias mail sont là à la rescousse !
...
![Rendu bureau](/static/img/alias-email-desktop.png)
...
[![Deploy projet to Netlify](https://www.netlify.com/img/deploy/button.svg#deploy-netlify)](https://app.netlify.com/start/deploy?repository=https://github.com/sylvainmetayer/alias-gandi-angular)

## Edit 2022

J'ai utilisé ce projet durant à peu plus d'un an avant de découvrir [SimpleLogin](https://simplelogin.io/), qui propose un service similaire mais beaucoup plus pratique et est bien plus abouti que le projet que j'avais commencé. Je n'exclus pas d'un jour retravailler sur mon projet, mais ne l'utilisant plus de façon active, il ne m'est plus très utile et est donc archivé.
